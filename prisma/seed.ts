...
async function main() {
  const permissions = [
    ...
    { name: "audit-logs:create", description: "Create audit logs" },
    { name: "audit-logs:update", description: "Edit audit logs" },
    { name: "audit-logs:delete", description: "Delete audit logs" },
  ];
